...
@SuppressWarnings({ "PMD.ForLoopsMustUseBraces", "PMD.IfElseStmtsMustUseBraces", "PMD.IfStmtsMustUseBraces",
        "PMD.EmptyStatementNotInLoop", "PMD.EmptyIfStmt", "PMD.WhileLoopsMustUseBraces", "PMD.CyclomaticComplexity",
        "PMD.ExcessiveClassLength", "PMD.ExcessiveMethodLength", "PMD.NcssMethodCount", "PMD.LooseCoupling" })
    ...
    private static String removePreposicoes(String str) {
        ...
        for (i = 0; i < palavra.size(); i++) {
            for (j = 0; j < prep.length; j++) {
                if (i >= 0 && palavra.elementAt(i).toString().compareTo(prep[j]) == 0) {
